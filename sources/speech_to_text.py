...
class Transcript:
    ...
    def remove_hallucinations(self, text: str) -> str:
        ...
        # Using regex to remove common Whisper hallucinations
        # We only remove specific, known artifact phrases, not common words.

        # Patterns for removal (case insensitive)
        patterns = [
            r"Subtitle(s)? by .*",
            r"Transcribed by .*",
